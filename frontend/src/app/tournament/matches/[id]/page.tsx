...
export default function MatchDetailsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 p-3 ">
      <div className=" max-w-4xl mx-auto">
        {/* Match Details */}
        <div className="bg-white  rounded-xl shadow-lg  border border-blue-200   pt-4">
          <h1 className="sm:text-3xl text-xl max-[430px]:text-lg flex  justify-center pb-10 font-semibold text-blue-900">
            {" "}
          ...
          <div className="grid grid-cols-2 gap-8">
            {/* Team 1 Column */}
            <div>
              <h2 className="text-xl font-semibold text-blue-900 mb-6 text-center  pb-3"></h2>
    ...
    <div className="rounded-lg">
      <ul className="space-y-1 p-2">
        {items.map((p) => (
          <li
            key={p.player_id}
            className="flex flex-wrap items-center  justify-between gap-x-0 gap-y-1 sm:text-base text-sm  sm:pb-1  pb-3"
          >
            ...
            <span className="font-semibold text-xs sm:text-base text-sm  text-blue-900">
              {type === "goals"
                ? `${p.goals}x ⚽`
                : type === "yellow"
                ? `🟨`
